...
String message = "직급 권한을 수정하지 못했습니다.";
...
boolean flag = permissionCon.changeProgramJobPermission(session, programCode, result);

if (flag) {
	message = "직급 권한 정보를 수정했습니다.";
}
%>
<body>
