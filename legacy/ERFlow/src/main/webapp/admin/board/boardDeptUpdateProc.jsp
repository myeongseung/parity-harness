...
String message = "부서 권한 정보를 수정하지 못했습니다.";
boolean flag = false;
...
switch (paramFlag) {
	case "read":
		...
		flag = permissionCon.changeBoardReadPermission(session, board, result, others);
		break;
	case "write":
		others = board.getJobWritePermissionLevel();
		flag = permissionCon.changeBoardWritePermission(session, board, result, others);
		break;
}
if (flag) {
	message = "부서 권한 정보를 수정하였습니다.";
}
%>
<body>
