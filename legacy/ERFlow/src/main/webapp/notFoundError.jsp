...
<head>
	...
	<link rel="stylesheet" href="/ERFlow/css/internalServerError.css">
</head>
...
<body>
	<div class="container">
		<div class="error">
			...
			<h2>ERROR</h2>
			<p>페이지를 찾을 수 없습니다.</p>
			<button class="error-button"><a href="/ERFlow/login/login.jsp">돌아가기</a></button>
		</div>
	...
	<script src="/ERFlow/js/internalServerError.js"></script>
</body>
