...
class PostViewCounterTest {
    ...
    void newPostWithExistingCookieDoesNotIncrement() {
        ...
        assertThat(PostViewCounter.shouldIncrement("10;11", 42)).isFalse();
    }
    ...
    void cookieGrowsOnRepeatView() {
        ...
        assertThat(PostViewCounter.nextValue("42", 42)).isEqualTo("42;42");
    }
    ...
    void newPostIsNotRecorded() {
        ...
        assertThat(PostViewCounter.nextValue("10;11", 42)).isEqualTo("10;11");
    }

    @Test
    @DisplayName("번호가 겹치는 접두사에 속지 않는다")
    void prefixIsNotAMatch() {
        assertThat(PostViewCounter.shouldIncrement("420;4", 42)).isFalse();
    }
}
